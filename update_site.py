...
awards.json, news.json, and index.html from your source spreadsheets and
articles. Doesn't touch git at all — commit and push through GitHub
...
build_news_json.py, and generate_home_page.py — it calls them exactly as
you would by hand, in order, and stops immediately if any required step
fails.

Usage:
    python3 update_site.py
    python3 update_site.py --master Master.xlsx --ifi 2026_IFI.xlsx --leagues Leagues.xlsx --awards Awards.xlsx --news articles --site site
"""
