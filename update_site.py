...
news.json, and index.html from your source spreadsheets and articles.
...
build_schedule_json.py, build_leagues_json.py, build_news_json.py, and
...
Usage:
    ...
    python3 update_site.py --master Master.xlsx --ifi 2026_IFI.xlsx --leagues Leagues.xlsx --news articles --site site
"""
...
def main():
    ...
    if not has_news:
        print(f"NOTE: no .docx articles found in '{args.news}' — skipping news.json. "
